...
// */
//public class CodeReachabilityAnalyzer2 {
//
...
//    private static final List<Set<String>> allMethods = new ArrayList<>();
...
//    private static final List<Set<String>> interfaces = new ArrayList<>();
//    private static final List<String> supers = new ArrayList<>();
//    private static final Map<Set<String>, String> interfaceMap2 = new HashMap<>();
//
//    /**
//     * Main execution:
...
//        CodeReachabilityAnalyzer2 analyzer = new CodeReachabilityAnalyzer2();
...
//     * @throws IOException N/A
//     */
//    protected static void analyzeJar(File jarFile, Boolean analyzeAnnotations) throws IOException {
...
//     * @throws IOException N/A
//     */
//    protected static void analyzeClass(JarFile jar, JarEntry entry, Boolean analyzeAnnotations) throws IOException {
...
//                            interfaceMap.put(fullMethodName, fullInterfaceName);
//                        }
//                    }
//                }
//            } catch (IOException e) {
...
//     */
//    protected static void getReachableVulnerableCodeExecutionPaths(List<List<String>> vulnerableCodeExecutionPaths, TreeNode<String> vulnerableCode, String vulnerabilityId) {
...
//     * @throws IOException
//     */
//    public static Map<String, Set<String>> readCallGraphFromGzipFile(String filename) throws IOException {
